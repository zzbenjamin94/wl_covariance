...
clusters_dir = '/global/cscratch1/sd/zzhang13/MultiDark/MDPL2_ROCKSTAR_Halos/z0p49/'
...
if __name__ == '__main__':
    ...
    cluster_df = pd.read_csv(clusters_dir + 'clusters_SAGE_mvir_gt_3e13_Dsep_lt_2_z0p49.csv')
    ...
    ptcl_files = glob(ptcl_dir + 'snap_112.*')
    ...
    if rank == 0:
        ...
        with open('sigma_mvir_1e14_2e14_z0p49.pkl','wb') as handle:
