...
ptcl_samp = 1000 #Read every 1000th particle
dz = 200 ## Projection depth Mpc/h

#Common variables.
mvir_low = 2e15; mvir_high = 5e15
sample_num = 500
...
if __name__ == '__main__':
    ...
    #Wait for all sample_num to change
    comm.Barrier()
    ...
    if rank == 0: print("Completed reading ptcl file")
    start_file = time()
    ...
    for i in range(n_start, n_end): #This part is different for different clusters. 
            ...
            print("Finished reading cluster")
            
    end_file = time()
    print("Time per file is: ", end_file - start_file)
    ...
    if rank == 0:
        ...
        with open('deltasigma_multiprocess_1000th_ptcl_test.pkl','wb') as handle:
