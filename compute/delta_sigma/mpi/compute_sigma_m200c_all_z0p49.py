...
omega_b = 0.0486 
hubble=0.6774
redshift = 0.49 ##This to modify for each snapshot!
...
if __name__ == '__main__':
    ...
    cluster_df = pd.read_csv(clusters_dir + 'clusters_m200c_n500_all_z0p49.csv' ) ##File with n500 samples in each bin
    ...
    if rank == 0:
        ...
        with open(clusters_dir+'sigma_m200c_all_z0p49.pkl','wb') as handle:
